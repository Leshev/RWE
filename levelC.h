// уровень игры C
void playLevelC(const std::string& userName) {
    int points;
    int loadPointPlayer;
    std::ifstream fin(userName + ".pc");
    if (fin.is_open()) {
        fin >> loadPointPlayer;
    ...
    const int NUM_WORDS = 120;
    const std::string WORDS[NUM_WORDS][NUM_FIELDS] = {
        {"chamber", "'Камера' на англ "},
        {"cop", "'Полицейский' на англ "},
        {"beast", "'Зверь' на англ "},
        {"palm", "'Ладонь' на англ "},
        {"tank", "'Бак/цистерна' на англ "},
        {"shield", "'Щит' на англ "},
        {"hate", "'Ненависть' на англ "},
        {"fleet", "'Флот/парк' на англ "},
        {"rod", "'Стержень' на англ "},
        {"empire", "'Империя' на англ "},
        {"leave", "'Отпуск' на англ "},
        {"doorway", "'Дверной проем' на англ "},
        {"commander", "'Командир' на англ "},
        {"fist", "'Кулак' на англ "},
        {"flesh", "'Плоть' на англ "},
        {"count", "'Подсчет' на англ "},
        {"blow", "'Удар' на англ "},
        {"troop", "'Отряд/войско' на англ "},
        {"motion", "'Движение' на англ "},
        {"crystal", "'Кристал' на англ "},
        {"voice", "'Голос' на англ "},
...
std::cout << "Ваш текущий счет: " << points << std::endl;
        std::ofstream pointSave(userName + ".pc");
