...
void playLevelB(const std::string& userName) {
    ...
    const std::string WORDS[NUM_WORDS][NUM_FIELDS] = {
        {"voice", "'Голос' на англ "},
        {"shoulder", "'Плечо' на англ "},
        {"stone", "'Камень' на англ "},
        {"humen", "'Человек' на англ "},
        {"death", "'Смерть' на англ "},
        {"ground", "'Земля/почва' на англ "},
        {"power", "'Мощьность/сила' на англ "},
        {"chance", "'Шанс' на англ "},
        {"point", "'Точка' на англ "},
        {"gun", "'Пистолет/пушка' на англ "},
        {"sense", "'Чувство' на англ "},
        {"thought", "'Мысль' на англ "},
        {"breath", "'Дыхание' на англ "},
        {"step", "'Шаг' на англ "},
        {"lip", "'Губа' на англ "},
        {"trouble", "'Беда' на англ "},
        {"talk", "'Разговор' на англ "},
        {"couple", "'Пара' на англ "},
        {"fear", "'Страх' на англ "},
        {"officer", "'Офицер' на англ "},
        {"weapon", "'Оружие' на англ "},
        {"control", "'Контроль' на англ "},
        {"force", "'Принуждение' на англ "},
        {"master", "'Мастер' на англ "},
        {"darkness", "'Темнота' на англ "},
        {"chest", "'Грудь/сундук' на англ "},
        {"deal", "'Сделка' на англ "},
        {"expression", "'Выражение' на англ "},
        {"shot", "'Выстрел/удар' на англ "},
        {"strength", "'Прочность' на англ "},
        {"agent", "'Агент' на англ "},
        {"anger", "'Гнев' на англ "},
        {"chief", "'Начальник' на англ "},
        {"spirit", "'Дух' на англ "},
        {"cell", "'Клетка' на англ "},
        {"movement", "'Движение' на англ "},
        {"evidence", "'Свидетельсьво' на англ "},
        {"flame", "'Пламя' на англ "},
        {"base", "'База' на англ "},
        {"risk", "'Риск' на англ "},
